...
estimadores = ['1st_order_jackknife_Mean', '2nd_order_jackknife_Mean', 'Chao2_Chao_1987__Mean', 'Chao2_bc_Mean',
               'Homogeneous_Model_Mean', 'ICE_1_Lee_Chao_1994__Mean', 'ICE_Lee_Chao_1994__Mean', 'iChao2_Chiu_et_al_2014__Mean', 
...
# --- Dibujar observadas ---
ax.plot(x, tabla_frec['Observadas_Mean'], 'o-', color='black', label='Observadas')
...
for est in top2:
    ax.plot(x, tabla_frec[est], 'o--', label=est.replace('_Mean', ''))
