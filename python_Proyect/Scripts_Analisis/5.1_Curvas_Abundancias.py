...
# --- Rutas ---
ruta_original = r"D:\CORPONOR 2025\Backet\python_Proyect\Resultados\5_Estimadores_Abundancia.xlsx"
ruta_limpia = r"D:\CORPONOR 2025\Backet\python_Proyect\Resultados\5_Estimadores_Abundancia.xlsx"
...
import pandas as pd
tabla_Abund = pd.read_excel(r"D:\CORPONOR 2025\Backet\python_Proyect\Resultados\5_Estimadores_Abundancia.xlsx")
...
# --- Cargar datos ---
ruta = r"D:\CORPONOR 2025\Backet\python_Proyect\Resultados\5_Estimadores_Abundancia.xlsx"
...
ruta_salida = r"D:\CORPONOR 2025\Backet\python_Proyect\Resultados\5.1_Efectividad_Estimadores.xlsx"
...
# --- Rutas ---
ruta_original = r"D:\CORPONOR 2025\Backet\python_Proyect\Resultados\5.1_Efectividad_Estimadores.xlsx"
ruta_limpia = r"D:\CORPONOR 2025\Backet\python_Proyect\Resultados\5.1_Efectividad_Estimadores.xlsx"
...
fig.savefig("D:/CORPONOR 2025/Backet/python_Proyect/Resultados/5.2_estimadores_riqueza.png",
...
# --- Guardar en Excel ---
ruta_salida = "D:/CORPONOR 2025/Backet/python_Proyect/Resultados/5.2.1_Resumen_estimadores.xlsx"
...
# --- Rutas ---
ruta_original = r"D:\CORPONOR 2025\Backet\python_Proyect\Resultados\5.2.1_Resumen_estimadores.xlsx"
ruta_limpia = r"D:\CORPONOR 2025\Backet\python_Proyect\Resultados\5.2.1_Resumen_estimadores.xlsx"
...
#----------------------- Graficar curvas de acumulación de especies -----------------------#
import pandas as pd
import matplotlib.pyplot as plt
import numpy as np
...
colocar_etiqueta(
    x[-1],
    tabla_Abund['Observadas_Mean'].iloc[-1],
    tabla_Abund['Observadas_Mean'].iloc[-1],
    ax
)
...
if 'Singletons_SD' in tabla_Abund.columns:
    ...
    colocar_etiqueta(
        x[-1],
        tabla_Abund['Singletons_SD'].iloc[-1],
        tabla_Abund['Singletons_SD'].iloc[-1],
        ax
    )
...
# =============================
fig.savefig(
    "D:/CORPONOR 2025/Backet/python_Proyect/Resultados/5.2_estimadores_riquezaPRO.png",
    dpi=300,
    bbox_inches='tight'
)
