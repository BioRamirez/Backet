...
library(readxl)
library(knitr)
library(kableExtra)  # 👈 necesario para el scroll

# Leer el archivo Excel
tabla <- read_excel("Esfuerzo_Muestreo.xlsx")

# Mostrar tabla completa con desplazamiento
kbl(tabla, caption = "Vista del archivo Esfuerzo_Muestreo.xlsx") %>%
  kable_styling(full_width = TRUE, font_size = 12) %>%
  scroll_box(height = "400px")  # 👈 altura del área visible
...
# Mostrar tabla completa con desplazamiento
kbl(tabla, caption = "Vista del archivo tabla_composicion_taxonomica.xlsx") %>%
  kable_styling(full_width = TRUE, font_size = 12) %>%
  scroll_box(height = "400px")  # 👈 altura del área visible
...
# Mostrar tabla completa con desplazamiento
kbl(tabla, caption = "Vista del archivo Riqueza_Orden_Familia.xlsx") %>%
  kable_styling(full_width = TRUE, font_size = 12) %>%
  scroll_box(height = "400px")  # 👈 altura del área visible
