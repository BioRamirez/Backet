...
# Leer el archivo Excel
tabla <- read_excel("Esfuerzo_Muestreo.xlsx")

#"D:\CORPONOR 2025\Backet\Esfuerzo_Muestreo.xlsx"

# Mostrar tabla completa en el documento
kable(tabla, caption = "Vista del archivo Esfuerzo_Muestreo.xlsx")
```
...
# Leer el archivo Excel
tabla <- read_excel("tabla_composicion_taxonomica.xlsx")

#"D:\CORPONOR 2025\Backet\tabla_composicion_taxonomica.xlsx"

# Mostrar tabla completa en el documento
kable(tabla, caption = "Vista del archivo tabla_composicion_taxonomica.xlsx")
```
...
# Leer el archivo Excel
tabla <- read_excel("Riqueza_Orden_Familia.xlsx")

# Mostrar tabla completa en el documento
kable(tabla, caption = "Vista del archivo Riqueza_Orden_Familia.xlsx")
```
